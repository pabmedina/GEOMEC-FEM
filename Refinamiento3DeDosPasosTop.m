...
function [nod3, elem3DSalida]=Refinamiento3DeDosPasosTop(nod3,elem3Entrada,elemARefinar)
...
%         aux61(3:3:end,:)=[];
    ...
    %0.3
    % 28-13 27-14 25-16 24-17 22-19 21-20 44-33 43-34 42-35 41-36 40-37
    % 39-38
    
    %0.5
    % 26-15 23-18 12-9 11-10 32-29 31-30
    
    corregirNodPor=[28 13 0.3
                    27 14 0.3
                    25 16 0.3
                    24 17 0.3
                    22 19 0.3
                    ...
                    32 29 0.5
                    31 30 0.5];
   for i=1:length(corregirNodPor(:,1))
%        [j, k, m]=[corregirNodPor(i,1) corregirNodPor(i,2) corregirNodPor(i,3)];
       j=corregirNodPor(i,1);
       k=corregirNodPor(i,2);
       m=corregirNodPor(i,3);
       
       nod3(j+numNod-8,:)=m*nod3(j+numNod-8,:)+(1-m)*nod3(k+numNod-8,:);
   end
    ...
    elem3DSalida=[  12+numNod-8 32+numNod-8 elem3Entrada(elemARefinar,3)  48+numNod-8 9+numNod-8  29+numNod-8 elem3Entrada(elemARefinar,7)  45+numNod-8
                    ...
                    39+numNod-8 47+numNod-8 11+numNod-8 40+numNod-8 38+numNod-8 46+numNod-8 10+numNod-8 37+numNod-8% El siguiente arrancan las tapas
                    26+numNod-8 12+numNod-8 48+numNod-8 elem3Entrada(elemARefinar,4) 27+numNod-8 43+numNod-8 44+numNod-8 28+numNod-8
                    elem3Entrada(elemARefinar,1) 47+numNod-8 11+numNod-8 23+numNod-8 21+numNod-8 39+numNod-8 40+numNod-8  22+numNod-8
                    23+numNod-8 11+numNod-8 12+numNod-8 26+numNod-8 24+numNod-8 41+numNod-8 42+numNod-8  25+numNod-8
                    47+numNod-8 elem3Entrada(elemARefinar,2) elem3Entrada(elemARefinar,3) 48+numNod-8 11+numNod-8 31+numNod-8 32+numNod-8  12+numNod-8
                    elem3Entrada(elemARefinar,1) 47+numNod-8 48+numNod-8 elem3Entrada(elemARefinar,4) 23+numNod-8 11+numNod-8 12+numNod-8  26+numNod-8];
