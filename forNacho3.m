function [tipo1_f1, tipo3_f1, tipo2_f1, tipo4_f1,tipo1_f2,tipo3_f2,tipo2_f2,tipo4_f2,tipo1_f3,tipo3_f3,tipo2_f3,tipo4_f3 ] = forNacho3(nel,nnodel,nodes,elements)  
...
%     d_estrato_1 = 80;
    ...
    for iele = 1:size(eleFisura1_ymenos,1)
        ...
        k = nodes(eleFisura1_ymenos(iele,:),3);
        for inod = 1:nnodel
            if  j(inod)>95 && i(inod)<300 && i(inod)>100 && k(inod)< d_estrato_5 && k(inod)> d_estrato_10
                ipa1(iele) = true;
            end
        end
    end
