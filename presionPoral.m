function Celemento = presionPoral(npg,upg,wpg,nodesEle,ndof,nnodel,ndofel,Biot)

Celemento = sparse(ndof*nnodel,nnodel);
...
%           
        ...
        Celemento = Celemento + B'*Biot*wpg(ipg)*N*det(jac);
