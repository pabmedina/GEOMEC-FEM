function vector_cargas = cargas_por_elementoTB(npg,upg,wpg,nodesEle,ndof,nnodel,Presion,ndofel_1)
...
for ipg = 1:npg
        ...
        Jacobiano = [jac(1,2)*jac(2,3) - jac(2,2)*jac(1,3)
                     jac(2,1)*jac(1,3) - jac(1,1)*jac(2,3)
