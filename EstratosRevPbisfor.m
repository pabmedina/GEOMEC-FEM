...
malla = 'M3';%'M22';%'M2';%'M333P';%'M333P';%'M3';%'M4';%'M3test';%%;%
...
% %% Opcion Nachote
% % aa = [nodes(nodos1_fisu1,:), nodes(nodos1_fisu1(orden1_1),:)];
% % bb = [nodes(nodos2_fisu1,:),nodes(nodos2_fisu1(orden1_2),:)];
% % dd = [nodes(nodos1_fisu1,:) nodes(nodos2_fisu1,:)];
% % ee = [nodes(nodos1_fisu1(orden1_1),:) nodes(nodos2_fisu1(orden1_2),:)];


% % elements_Barra = [ nodos1_fisu1(orden1_1)  nodos2_fisu1(orden1_2)
% %                    nodos1_fisu2(orden2_1)  nodos2_fisu2(orden2_2)
% %                    nodos1_fisu3(orden3_1)  nodos2_fisu3(orden3_2)];             %% Falta ordenar correctamente para obtener el nodo enfrentado
% %                
% % elements_Barra_fisu1 = [ nodos1_fisu1(orden1_1)  nodos2_fisu1(orden1_2)];
% % elements_Barra_fisu2 = [ nodos1_fisu2(orden2_1)  nodos2_fisu2(orden2_2)];
% % elements_Barra_fisu3 = [ nodos1_fisu3(orden3_1)  nodos2_fisu3(orden3_2)];
% 
% nodos1_fisu1=nodos1_fisu1(orden1_1);  
% nodos2_fisu1=nodos2_fisu1(orden1_2);
% nodos1_fisu2=nodos1_fisu2(orden2_1);  
...
nTiempo = deltaT*1;% deltaT*18*3;% deltaT*18;%      %Decia deltaT*10 MOD NACHO!
