...
%%% M22: 640 elementos
%%% M3: 2560 elementos
%%% M333P: 10240 elementos              % Esta tarda 19 min por time step en Hilbert
%%% M3test: 11264 elementos             % Tampoco la corras
%%% M333: 15360 elementos               % no corras nunca esta malla, no converge ni en pedo y tarda un montón 
...
nNod = size(nodes,1);  % numero de nodos sin considerar los resortes
% PlotFieldonMesh(nodes,elements,ones(nNod,1))
...
nTiempo = deltaT*18;%  deltaT*18*3;%      % Decia deltaT*10 MOD NACHO!
...
% kappa_int = 1e-3*5*9.8669e-13;%1e-3*5*9.8669; %
% mu_dinamico = 2e-4;
...
desp_1 = 0.05; %   0.5; %   %% Definirlo según el módelo de resorte que se elija. Eso va a depender de la distancia al wellbore

despRot = 0.14;  %   0.6; %   %% Definirlo según el módelo de resorte que se elija. Eso va a depender de la distancia al wellbore
...
%         Pin = 12e5*(itime - 1) + relax*12e5*(itime-1);% 12e5*(itime-1) + 12e5*(itime-1)*relax;
    ...
    if itime == 1
        if iter == 1
        nodNew          = nodes;
        P_old           = PresionPoralInicial*1.01*ones(length(nodNew),1);
        nodOld          = nodes;
    ...
    vars4solve = struct('K',K,...
                        'k_barras',k_barras,...
                        'dof_barras',dof_barras,...
                        'D_P',D_P,...
                        'Rr',Rr,...
                        'C_g',C_g,...
                        'S',S,...
                        ...
                        'KC',KC,...
                        'ndof',ndof,...
                        'nelSpringFisura',nelSpringFisura,...
                        'nodeDofs',nodeDofs,...
                        'ndofel_b',ndofel_b,...
                        ...
                        'itime',itime,...
                        'nnod',nnod,...
                        'PresionPoralInicial',PresionPoralInicial,...
                        ...
                        'isFixedp',isFixedp,...
                        'nodes_tot',nodes_tot,...
                        'iteracionError',iteracionError,...
                        'gapViejo',gapViejo,...
                        'count2',count2,...
                        'desp_1Variable',desp_1Variable,...
                        'E_BB',E_BB,...
                        'despRot',despRot,...
                        'E_B',E_B,...
                        'fcn',fcn,...
                        'elements_Barra_fisu1',elements_Barra_fisu1,...
                        'elements_Barra_fisu2',elements_Barra_fisu2,...
                        'elements_Barra_fisu3',elements_Barra_fisu3,...
                        'nod_in',nod_in,...
                        'pBC',pBC,...
                        'RNACHO',RNACHO,...
                        'RTOT',RTOT,...
                        'Pressure',Pressure,...
                        'sizeFisu1_1',sizeFisu1_1,...
                        'ele_fisu1_y1_1',ele_fisu1_y1_1,...
                        'sizeFisu1_2',sizeFisu1_2,...
                        'ele_fisu1_y1_2',ele_fisu1_y1_2,...
                        'ndofel_2',ndofel_2,...
                        'sizeFisu2_1',sizeFisu2_1,...
                        'ele_fisu2_y2_1',ele_fisu2_y2_1,...
                        'sizeFisu2_2',sizeFisu2_2,...
                        'ele_fisu2_y2_2',ele_fisu2_y2_2,...
                        'sizeFisu3_1',sizeFisu3_1,...
                        'sizeFisu3_2',sizeFisu3_2,...
                        'ele_fisu3_y3_1',ele_fisu3_y3_1,...
                        'ele_fisu3_y3_2',ele_fisu3_y3_2,...
                        'ndofel',ndofel,...
                        'nnodel',nnodel,...
                        'ndofel_1',ndofel_1,...
                        'ndoftot',ndoftot,'ifis',ifis,'nodes',nodes,'elements',elements,'elements_Barra',elements_Barra);

        Presion = pressureDistribution(vars4solve);  %%% la devuelve ordenada como el elementsBarra         
        ...
        [Desplazamientos,PorePressure,Qfisuras,nodePosition,error,iter]=pressure4LeakOff(vars4solve);
